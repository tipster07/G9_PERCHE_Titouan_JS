document.addEventListener("DOMContentLoaded", function(){
  ...
  const filterizr = new Filterizr(".portfolio-elements", options);//je n'ai pas reussi a faire en sorte que le code reconaisse la librairie
...
const swiper = new Swiper('.mon-slider', {//je n'ai pas reussi a faire en sorte que le code reconaisse la librairie
  // Optional parameters
